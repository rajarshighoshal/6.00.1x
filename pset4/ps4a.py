...
def isValidWord(word, hand, wordList):
    ...
    if not word in wordList:
        ...
        for key in wordDict.keys():
            if not hand.get(key, 0) >= wordDict.get(key, 0):
                flag = False
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('"{}" earned {} points. Total: {} points'.format(userinput, wordScore, totalScore))
                print()
                # Update the hand 
...
def playGame(wordList):
    ...
    while True:
        ...
        if data == 'n':
            ...
            # calling playhand function for playing the hand
